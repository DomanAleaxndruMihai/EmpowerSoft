...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
      ...
      <div style="margin-top: 20px;">
        <img src="../images/suport.png" id="comp1" > 
      </div>

      <h3 style="text-align: center;">Ai nevoie de ajutor?</h3>
      <h5 style="text-align: center;">Unul dintre voluntarii nostrii este gata sa te ajute sa formezi urmatoarele generatii! </h5>
     

<p style="text-align: center;">
  <br><br>
  Programeaza o intalnire la numarul de telefon <b>0721301420</b> pentru a programa o intalnire live cu unul dintre voluntarii Learninro.
</p>
