...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
  ...
  <p style="text-align: center; margin-bottom:30px; width:70%;  margin-left:15%;">Zoom Video Communications este o companie americană de tehnologie a comunicațiilor. Oferă servicii de telefonie video și chat online printr-o platformă software peer-to-peer bazată pe cloud și este utilizată pentru teleconferințe, telecomunicații, educație la distanță și relații sociale.
...
<div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
    <div class="card-body">
        <p><br>
          <b> Pasul 1:</b><br>
          Ca gazdă a întâlnirii, faceți clic pe Participanții ("Participants"). <br><br> 
          <b> Pasul 2:</b><br>
          Faceți click pe "Admit" pentru ca participantul să se alăture întâlnirii. <br>
          <img src="../images/zoom/zoom4.png"  class="instructionpic" alt="zoom"><br><br> 
          Daca doriti sa aprobati toti elevii atunci faceți clic pe Admitere toti (Admit All). <br>
...
<div class="accordion" id="accordionExample">
    <div class="card">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
                <p><br>
                  Puteți opri microfonul tuturor participanților care sunt deja la întâlnire, precum și noii participanți care se alătură reuniunii. <br>
                  De ex: daca elevii fac galagie la o lectie online putem apasa optiunea "Mute all" si atunci microfonul tuturor elevilor o sa fie oprit. <br><br>
                    <b>Pasul 1:</b> <br>
                    Selectați Participanți - "Participants"<br><br> 
                    ...
                    <b> Nota:</b><br>
                    Daca doriti ca participantii sa poata vorbi va trebuii să permiteți participanților să porneasca microfonul - "Allow participants to unmute themselves". Dacă faceți click pe Continue, veți opri microfonul participanților.<br><br> 
